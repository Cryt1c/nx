...
export async function resolveCurrentVersion(
  ...
  let currentVersionResolver:
    | NxReleaseVersionV2Configuration['currentVersionResolver']
    | undefined;
  ...
  if (projectVersionConfig?.currentVersionResolver) {
    currentVersionResolver = projectVersionConfig.currentVersionResolver;
    currentVersionResolverMetadata =
      projectVersionConfig.currentVersionResolverMetadata ?? {};
  } else if (releaseGroupVersionConfig?.currentVersionResolver) {
    currentVersionResolver = releaseGroupVersionConfig.currentVersionResolver;
    currentVersionResolverMetadata =
